...
const devs = ['545635609738215424'];
const db = require('quick.db');
const premium = ['545635609738215424']
...
message.channel.send(
  ...
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/QCVVrfj**")
